...
def extract_card_geometry_spec(
    ...
    braille_to_dots_func: Optional[Callable[[str], List[int]]] = None,
) -> Dict[str, Any]:
    """
...
def _create_dot_spec(x: float, y: float, settings: Any, shape_type: str = 'standard', plate_type: str = 'positive'):
