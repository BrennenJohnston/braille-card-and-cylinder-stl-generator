...
def main():
    ...
    # Positive card (g1/g2)
    endpoints.append((f"{base}/generate_braille_stl", build_payload_positive(["⠠⠃⠗⠁⠊⠇⠇⠑", "⠉⠁⠗⠙"], grade="g1", shape_type="card")))
    endpoints.append((f"{base}/generate_braille_stl", build_payload_positive(["⠠⠃⠗⠁⠊⠇⠇⠑", "⠉⠽⠇⠊⠝⠙⠑⠗"], grade="g2", shape_type="card")))

    # Positive cylinder (g2)
    endpoints.append((f"{base}/generate_braille_stl", build_payload_positive(["⠉⠽⠇⠊⠝⠙⠑⠗"], grade="g2", shape_type="cylinder")))
